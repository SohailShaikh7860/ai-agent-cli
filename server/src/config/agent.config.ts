...
function displayFileTree(files: any[], folderName: any) {
  ...
  Object.keys(filesByDir)
    ...
    .forEach((dir) => {
      if (dir) {
        ...
        filesByDir[dir].forEach((file: string) => {
...
async function createApplicationFiles(baseDir: string , folderName: string, files: any[]) {
...
export async function generateApplication(
  ...
  try {
    printSystem(
      chalk.cyan("🤖 Agent mode: Generating application structure...\n")
    );
